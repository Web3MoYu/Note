...
![](软件开发/Linux/Docker/img/8.png)

**加载文件 恢复为镜像**

![](软件开发/Linux/Docker/img/9.png)

**查看镜像 测试镜像功能是否正常**

我们来把解压的镜像 run一下。

![](软件开发/Linux/Docker/img/10.png)
...
![](软件开发/Linux/Docker/img/17.png)

然后**删除容器** -----不经意间 咱发现已经运行过这么多容器了 咱进行清理一下

![](软件开发/Linux/Docker/img/18.png)
...
![](软件开发/Linux/Docker/img/28.png)

为了区分 咱停止并删除之前tomcat 的容器

![](软件开发/Linux/Docker/img/29.png)
...
![](软件开发/Linux/Docker/img/30.png)

![](软件开发/Linux/Docker/img/31.png)
