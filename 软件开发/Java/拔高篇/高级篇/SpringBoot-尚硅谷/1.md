...
### 官网文档架构
![](image\20210205004733270.png))
![](image\20210205004828702.png))

[查看版本新特性](https://github.com/spring-projects/spring-boot/wiki#release-notes)

![](image\20210205005342147.png))
...
![](image\20210205005802305.png))
其中，保存了所有`@RequestMapping` 和`handler`的映射规则。

![](image\20210205005926474.png))
